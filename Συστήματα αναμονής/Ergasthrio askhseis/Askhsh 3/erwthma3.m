...
while transitions >= 0
  ...
  if current_state==1 treshold=lambda/(lambda+mu1); end 
  if current_state==2 treshold=lambda/(lambda+mu2); end 
  if current_state==3 treshold=lambda/(lambda+mu1+mu2); end 

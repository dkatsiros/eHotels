...
<?php include 'variables.php'?>
  <head>
    <title>Διαγραφή ενικοίασης</title>
...
<div class="w3-container w3-blue backup-wrapper">
 ...
 $hotel_room_id = mysqli_real_escape_string($link,$_POST['hotel_room_id']);
  ...
  $sql2="SELECT * FROM rents WHERE Customer_IRSnumber='$customer_irs_number' AND Employee_IRSnumber='$employee_irs_number' AND Hotel_room_Room_id='$hotel_room_id' ";
  if ($res = $link->query($sql2)) {

    /* Check the number of rows that match the SELECT statement */
    if(mysqli_num_rows($res) > 0) {
        $sql = "DELETE FROM rents 
                WHERE Customer_IRSnumber='$customer_irs_number' AND Employee_IRSnumber='$employee_irs_number' AND Hotel_room_Room_id='$hotel_room_id'";
...
?>
<br /><br />
<a href="delete_rent_html.php" class="white-button">Επιστροφή στην διαγραφή ενοικίασης</a>
<br /><br /><br />

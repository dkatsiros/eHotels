<html lang="gre">
<?php include 'variables.php'; session_start();?>
  <head>
...
<?php
	...
	while ($row = mysqli_fetch_array($query) )
 {
	...
	if($row['Paid']=='no' or $row['Paid']=='NO' or $row['Paid']=='No' ){
     echo '<tr>
    <td>'.$no.'</td>
    ...
    <td>'.$row['Paid'] .'</td>
	<td> <a href="to_be_rent.php?number='.$no.'&Customer_IRSnumber='.$row['Customer_IRSnumber'].'
										&Hotel_id='.$row2['Hotel_id'].'
										&Hotel_room_Room_id='.$row['Hotel_room_Room_id'].'

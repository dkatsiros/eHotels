...
<div class="w3-container w3-blue backup-wrapper">
  ...
  if ($res = $link->query($sql2)) {
    ...
    {
        echo "The employee  you want to delete doesnt exists!";
    }
}
else
     {
...
?>
<br /><br />
<a href="delete_employee_html.php" class="white-button">Επιστροφή στην διαγραφή υπαλλήλων</a>
<br /><br /><br />

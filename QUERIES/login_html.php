          ...
          <form class="search-adjustment" action="search.php" method="post">
            <header class="search-now-header">
                ...
                <div class="search-button-press">
                    <input class="search-button-edit" class="search-button" type="submit"></input>
                </div>
      </form>
  </section>
...
<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
      <div class="advanced-search">
        <h2>Περισσότερα Κριτήρια:</h2>
        <ul method="post" action="search.php" class="advanced-search-list">
          <li>
              <div class=""> <h3>Αλυσίδα ξενοδοχείων:</h3>
                <input type="number" min="0" name="chain">
              </div>
              <br />
            </li>
            <li>
              <div class=""> <h3>Αστέρια:</h3>
          ...
          <li>
            <div class=""> <h3> Συνολικός αριθμός δωματίων: </h3>
        ...
        <ul> <h3>Παροχές:</h3><br> 
          ...
          <li>
            <label class="our-checkbox"> TV
              <input type="checkbox" name="amenities[]"  value="tv" checked="checked">
              <span class="checkmark"></span>
          </li>
        <li>
        ...
        <li>
          <label class="our-checkbox"> Private Pool

...
<div class="w3-container w3-blue">
  <h2>Εισάγετε τα στοιχεία της κράτησης:</h2>
      ...
      <form action="insert_reserves.php" method="post" class="w3-container"><br/>
        <?php session_start();  ?>
        <input type="hidden" class="w3-input" name="customer_irs_number" value="<?php  echo $_SESSION['customer_irs_option']; ?> " >   
        <input type="hidden" class="w3-input" name="hotel_room_room_id" value="<?php  echo $_SESSION['room_id_option']; ?>" >  
        ...
        <input type="hidden" name="paid"  class="w3-input" value="no" required><br/>      

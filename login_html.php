<html lang="gre">
  ...
  <head>
        <link rel="stylesheet" type="text/css" href="eHotel.css">
        ...
        <ul> Παροχές:<br><br>
          ...
          <li>
            <label class="our-checkbox"> Air_Condition
              <input type="checkbox" name="amenities[]"  value="air_condition" checked="checked">
              <span class="checkmark"></span>
          </li>
          <li>
            <label class="our-checkbox"> Private_Pool
              <input type="checkbox" name="amenities[]"  value="private_pool" checked="checked">
              <span class="checkmark"></span>
          </li>
        </ul>
        </li> 
